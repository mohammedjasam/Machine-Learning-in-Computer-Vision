...
5. "VariableK" is a flag to enable the multiple k run, you can expect the Accuracy Matrix of K vs Euclidean, Manhattan, Mahalanobis
6. If you execute VariableK you will also have 3 graphs displaying K vs similarity measure.